...
/* j'ai rtiré ceci en comme car il manque le dictpath pour detect, à modif avant d'enlever des comms
...
void test_reuni_Detection(void){
    ...
    test_binary2();
    test_binary1();
    test_pretty_print_detection_null();
    //test_detect_error_handling();
}
/*
int main() {
